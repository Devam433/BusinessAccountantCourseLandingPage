  ...
  <div className="max-w-7xl mx-auto">
    <div id="contactUs" className={`bg-white rounded-2xl shadow-2xl overflow-hidden transition-all 
      ...
      <div className="grid md:grid-cols-2 gap-0">
        {/* Left panel */}
        <div className="bg-[#F5D951] text-[#000000] p-12 relative overflow-hidden">
        ...
        <div className="bg-white p-12">
          {isSubmitted ? (
            <div className="h-full flex flex-col items-center justify-center text-center">
              <div className="w-16 h-16 bg-[#F4F2E3] rounded-full flex items-center 
                justify-center mb-6 animate-bounce">
                <CheckCircle className="text-[#F5D951]" size={32} />
              </div>
              <h4 className="text-2xl font-bold text-[#000000] mb-4">Thank You!</h4>
              <p className="text-gray-600">Your message has been sent successfully.</p>
            </div>
          ) : (
            <form onSubmit={handleSubmit} className="space-y-6">
              <h4 className="text-2xl font-bold text-[#000000] mb-6">Get Started Today</h4>

              <div className="space-y-2">
                <label className="block text-[#000000] font-medium">Your Name</label>
                <input
                  type="text"
                  name="name"
                  value={formData.name}
                  onChange={handleChange}
                  className={`w-full border ${errors.name ? 'border-red-500' : 'border-[#F5D951]'} 
                    rounded-lg px-4 py-3 focus:outline-none focus:ring-2 focus:ring-[#F5D951] 
              ...
              <div className="space-y-2">
                <label className="block text-[#000000] font-medium">Phone Number</label>
                <input
                  type="number"
                  name="phone"
                  value={formData.phone}
                  onChange={handleChange}
                  className={`w-full border ${errors.phone ? 'border-red-500' : 'border-[#F5D951]'} 
                    rounded-lg px-4 py-3 focus:outline-none focus:ring-2 focus:ring-[#F5D951] 
                    transition-colors duration-200`}
              ...
              <div className="space-y-2">
                <label className="block text-[#000000] font-medium">Message</label>
                <textarea
                  name="message"
                  value={formData.message}
                  onChange={handleChange}
                  className={`w-full border ${errors.message ? 'border-red-500' : 'border-[#F5D951]'} 
                    rounded-lg px-4 py-3 focus:outline-none focus:ring-2 focus:ring-[#F5D951] 
              ...
              <button 
                className="w-full bg-[#F5D951] text-[#000000] py-4 rounded-lg font-semibold
                  transform transition-all duration-200 hover:bg-[#e3c94c] hover:scale-[1.02]
                  focus:outline-none focus:ring-2 focus:ring-[#F5D951] focus:ring-offset-2
